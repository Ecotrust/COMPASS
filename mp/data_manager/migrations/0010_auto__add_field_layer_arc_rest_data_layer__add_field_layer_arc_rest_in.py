...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.arc_rest_data_layer'
        db.add_column(u'data_manager_layer', 'arc_rest_data_layer',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Layer.arc_rest_instance_id'
        db.add_column(u'data_manager_layer', 'arc_rest_instance_id',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=150, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Layer.arc_rest_service_name'
        db.add_column(u'data_manager_layer', 'arc_rest_service_name',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Layer.arc_rest_out_fields'
        db.add_column(u'data_manager_layer', 'arc_rest_out_fields',
                      self.gf('django.db.models.fields.CharField')(default='*', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.arc_rest_data_layer'
        db.delete_column(u'data_manager_layer', 'arc_rest_data_layer')

        # Deleting field 'Layer.arc_rest_instance_id'
        db.delete_column(u'data_manager_layer', 'arc_rest_instance_id')

        # Deleting field 'Layer.arc_rest_service_name'
        db.delete_column(u'data_manager_layer', 'arc_rest_service_name')

        # Deleting field 'Layer.arc_rest_out_fields'
        db.delete_column(u'data_manager_layer', 'arc_rest_out_fields')
    ...
    models = {
        ...
        u'data_manager.layer': {
            ...
            'arc_rest_instance_id': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'arc_rest_out_fields': ('django.db.models.fields.CharField', [], {'default': "'*'", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
