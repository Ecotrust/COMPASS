...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Layer.arc_rest_out_fields'
        db.alter_column(u'data_manager_layer', 'arc_rest_out_fields', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Layer.arc_rest_out_fields'
        db.alter_column(u'data_manager_layer', 'arc_rest_out_fields', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
