...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layer.compass_instance_id'
        db.add_column(u'data_manager_layer', 'compass_instance_id',
                      self.gf('django.db.models.fields.CharField')(default='uUvqNMGPm7axC2dD', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Layer.compass_service_name'
        db.add_column(u'data_manager_layer', 'compass_service_name',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layer.compass_instance_id'
        db.delete_column(u'data_manager_layer', 'compass_instance_id')

        # Deleting field 'Layer.compass_service_name'
        db.delete_column(u'data_manager_layer', 'compass_service_name')
