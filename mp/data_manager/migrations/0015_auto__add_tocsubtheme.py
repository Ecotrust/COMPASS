...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TOCSubTheme'
        db.create_table(u'data_manager_tocsubtheme', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('display_name', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'data_manager', ['TOCSubTheme'])

        # Adding M2M table for field layers on 'TOCSubTheme'
        m2m_table_name = db.shorten_name(u'data_manager_tocsubtheme_layers')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('tocsubtheme', models.ForeignKey(orm[u'data_manager.tocsubtheme'], null=False)),
            ('layer', models.ForeignKey(orm[u'data_manager.layer'], null=False))
        ))
        db.create_unique(m2m_table_name, ['tocsubtheme_id', 'layer_id'])

        # Adding M2M table for field subthemes on 'TOCTheme'
        m2m_table_name = db.shorten_name(u'data_manager_toctheme_subthemes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('toctheme', models.ForeignKey(orm[u'data_manager.toctheme'], null=False)),
            ('tocsubtheme', models.ForeignKey(orm[u'data_manager.tocsubtheme'], null=False))
        ))
        db.create_unique(m2m_table_name, ['toctheme_id', 'tocsubtheme_id'])


    def backwards(self, orm):
        # Deleting model 'TOCSubTheme'
        db.delete_table(u'data_manager_tocsubtheme')

        # Removing M2M table for field layers on 'TOCSubTheme'
        db.delete_table(db.shorten_name(u'data_manager_tocsubtheme_layers'))

        # Removing M2M table for field subthemes on 'TOCTheme'
        db.delete_table(db.shorten_name(u'data_manager_toctheme_subthemes'))
