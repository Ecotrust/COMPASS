...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'data_manager_layer', 'url', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Layer.url'
        db.alter_column(u'data_manager_layer', 'url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
