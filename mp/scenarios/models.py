...
class GridCell(models.Model):
    ...
    Hex_ID = models.IntegerField(null=True, blank=True)
    AUSPATID = models.IntegerField(null=True, blank=True)
    ER_Code = models.IntegerField(null=True, blank=True)
    MarxanStat = models.IntegerField(null=True, blank=True)
    MarxanEcor = models.IntegerField(null=True, blank=True)
    COA2005 = models.IntegerField(null=True, blank=True)
    SGCore = models.IntegerField(null=True, blank=True)
    TNC = models.IntegerField(null=True, blank=True)
    COA2015 = models.IntegerField(null=True, blank=True)
    Boundary = models.IntegerField(null=True, blank=True)

    Perm_Mean = models.FloatField(null=True, blank=True)
    Resist_Mea = models.FloatField(null=True, blank=True)
    GAP1_PC = models.FloatField(null=True, blank=True)
    GAP2_PCT = models.FloatField(null=True, blank=True)
    GAP3_PCT = models.FloatField(null=True, blank=True)
    GAP4_PCT = models.FloatField(null=True, blank=True)
    PVT_PCT = models.FloatField(null=True, blank=True)
    GAP1_Acres = models.FloatField(null=True, blank=True)
    GAP2_Acres = models.FloatField(null=True, blank=True)
    GAP3_Acres = models.FloatField(null=True, blank=True)
    GAP4_Acres = models.FloatField(null=True, blank=True)
    PVT_Acres = models.FloatField(null=True, blank=True)
    Raw_SIndex = models.FloatField(null=True, blank=True)
    Marxan_SIn = models.FloatField(null=True, blank=True)
